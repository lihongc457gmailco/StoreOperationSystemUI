...
public class MainUI extends JFrame {
    ...
    private void initComponents() {
        ...
        // INCREASED ROWS TO 7 just to be safe (Header + 5 Buttons)
        ...
        JButton btnTransaction = createSidebarButton("Transaction History"); // <--- You created this
        JButton btnLogout = createSidebarButton("Logout");
        
        btnLogout.setBackground(new Color(192, 57, 43));
        btnLogout.setForeground(Color.WHITE);

        // --- FIX 1: ADD BUTTONS TO PANEL ---
        sidebar.add(btnAttendance);
        sidebar.add(btnStock);
        sidebar.add(btnSales);
        sidebar.add(btnTransaction); // <--- YOU MISSED THIS LINE
        ...
        btnTransaction.addActionListener(e -> cardLayout.show(contentPanel, "Transactions")); // <--- YOU MISSED THIS TOO
