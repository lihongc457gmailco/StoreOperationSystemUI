...
public class StockPanel extends JPanel {
    ...
    private void showFinalResultTable() {
        ...
        JPanel conclusionPanel = new JPanel(new FlowLayout(FlowLayout.CENTER,20,10));
        conclusionPanel.setBorder(BorderFactory.createMatteBorder(1,0,0,0,Color.LIGHT_GRAY));

        resultDialog.add(new JScrollPane(resultTable), BorderLayout.CENTER);
        
        //Conclusion Panel
        JPanel conclusionContainer = new JPanel(new BorderLayout());
        conclusionContainer.setBorder(BorderFactory.createEmptyBorder(10,10,10,10));
        JPanel statsPanel = new JPanel(new GridLayout(3, 1, 5, 5));
        statsPanel.setBorder(BorderFactory.createTitledBorder("SUMARRY"));
        ...
        conclusionContainer.add(statsPanel, BorderLayout.CENTER);
        
        JPanel bottomContainer = new JPanel(new BorderLayout());
        bottomContainer.add(conclusionPanel, BorderLayout.NORTH);
